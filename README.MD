...
| $__timeGroup(dateColumn, interval) | Will be replaced by an expression usable in a GROUP BY clause. For example, datetime((strftime('%s', order_date) / 60) * 60, 'unixepoch') |
